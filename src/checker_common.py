...
def run_command(
    command: str, check: bool = False, print_output: bool = True
...
def create_k8s_objects(
    yaml_path: str, kubectl_path: str, mappings: dict[str, str] | None = None
...
def expand_template(yaml_template: str, mappings: dict[str, str] | None) -> str:
