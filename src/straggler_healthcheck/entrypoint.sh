...
export NCCL_GPUDIRECTTCPX_CTRL_DEV="${NCCL_GPUDIRECTTCPX_CTRL_DEV:-eth0}"
export NCCL_GPUDIRECTTCPX_UNIX_CLIENT_PREFIX="${NCCL_GPUDIRECTTCPX_UNIX_CLIENT_PREFIX:-UNUSED}"
export NCCL_GPUDIRECTTCPX_PROGRAM_FLOW_STEERING_WAIT_MICROS="${NCCL_GPUDIRECTTCPX_PROGRAM_FLOW_STEERING_WAIT_MICROS:-UNUSED}"
export NCCL_GPUDIRECTTCPX_FORCE_ACK="${NCCL_GPUDIRECTTCPX_FORCE_ACK:-UNUSED}"
export NCCL_GPUDIRECTTCPX_TX_BINDINGS="${NCCL_GPUDIRECTTCPX_TX_BINDINGS:-UNUSED}"
export NCCL_GPUDIRECTTCPX_RX_BINDINGS="${NCCL_GPUDIRECTTCPX_RX_BINDINGS:-UNUSED}"
export NCCL_GPUDIRECTTCPX_SOCKET_IFNAME="${NCCL_GPUDIRECTTCPX_SOCKET_IFNAME:-UNUSED}"
...
cp -r /usr/local/tcpx /usr/local/fastrak_exec
