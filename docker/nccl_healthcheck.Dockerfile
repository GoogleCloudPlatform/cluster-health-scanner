...
COPY src/src/nccl_healthcheck/config.proto /scripts/
...
COPY src/src/nccl_healthcheck/nccl_startup.py /scripts/
COPY src/src/nccl_healthcheck/config.py /scripts/
COPY src/src/nccl_healthcheck/run-nccl-combined-plugins.sh .
