...
COPY src/health_checks/src/nccl_pairwise/nccl_startup.py /scripts/
COPY src/health_checks/src/nccl_pairwise/nccl_healthcheck/config.py /scripts/
COPY src/health_checks/src/nccl_pairwise/nccl_healthcheck/run-nccl-combined-plugins.sh .
