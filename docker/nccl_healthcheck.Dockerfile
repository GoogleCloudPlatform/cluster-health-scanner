...
COPY src/health_checks/src/nccl_healthcheck/config.proto /scripts/
...
COPY src/health_checks/src/nccl_healthcheck/nccl_startup.py /scripts/
COPY src/health_checks/src/nccl_healthcheck/config.py /scripts/
COPY src/health_checks/src/nccl_healthcheck/run-nccl-combined-plugins.sh .
