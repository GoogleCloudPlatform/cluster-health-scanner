...
An in-development tool for diagnosing cluster issues.

The cluster_diag Tool is a helpful wrapper around the Cluster Health Scanner
(CHS) diagnostic tool for the
...
NOTE: While CHS currently supports `a3-ultragpu-8g`, the CLI does not. It must be run
...
Usage: cluster_diag.par healthscan [OPTIONS] {a3-highgpu-8g | a3-megagpu-8g}
